...
<template>
  <div ref="containerRef" class="relative">
    ...
    >
      <h4
        class="text-heading px-2 py-1 border-b-2 border-border text-xs"
      >
        {{ project.title }}
      </h4>
        ...
        <div v-if="projectState.active" class="flex justify-center z-0 py-5">
          <div class="w-72 space-y-5">
            <div v-if="project.languages.length > 0" class="pl-2">
              <span v-for="lang in project.languages" class="mr-1 mb-1 inline-flex gap-2 relative p-2 border-2 border-border group">
